...
const testimonialsServices = __importStar(require("../../services/testimonials"));
const general_1 = require("../general");
const adminTestimonials = (_, args) => {
    return testimonialsServices.getAdminTestimonials(args.filters);
};
const createTestimonial = (_, args) => {
    return testimonialsServices.createTestimonial(args.data);
};
const updateTestimonial = (_, args) => {
    return testimonialsServices.updateTestimonial(args.data);
};
exports.testimonialsResolvers = {
    Query: {
        adminTestimonials,
    },
    Mutation: {
