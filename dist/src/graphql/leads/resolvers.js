...
exports.leadsResolvers = void 0;
const services = __importStar(require("../../services/contactLeads"));
const getAdminLeads = (_, __, _context) => {
    return services.getAdminLeads().then((leads) => leads.edges);
};
const createContactLeadResolver = (_, args) => {
    return services.createContactLead(args.data);
};
const updateContactLeadResolver = (_, args) => {
    return services.updateContactLead({ ...args.data });
};
exports.leadsResolvers = {
    Query: {
        getAdminLeads,
    },
    Mutation: {
