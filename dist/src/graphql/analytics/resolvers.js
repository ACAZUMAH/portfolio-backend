...
const services = __importStar(require("../../services/analytics"));
const getAnalyticsSummary = (_, args) => {
    return services.getAnalyticsSummary(args.days);
};
const trackVisitResolver = (_, args) => {
    return services.trackVisit(args.data);
};
const trackProjectImpressionResolver = (_, args) => {
    return services.trackProjectImpression(args.data);
};
const trackResumeDownloadResolver = (_, args) => {
    return services.trackResumeDownload(args);
};
const trackOutboundClickResolver = (_, args) => {
